...
/**
 * Servlet implementation class RatePlayerServlet
 */
@WebServlet("/rate_player")
public class RatePlayerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<PlayerModel> players = controller.getAllPlayersInfo();
